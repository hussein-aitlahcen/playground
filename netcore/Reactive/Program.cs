...
namespace Reactive
{
    ...
    class Program
    {
        ...
        [Pure]
        static IObservable<Func<State, State>> MorphismStream(IObservable<Event> eventStream) =>
        ...
        static IObservable<State> StateStream() =>
            MorphismStream(EventStream()).FullTransformationMonoid().Select(f => f(State.Empty));
